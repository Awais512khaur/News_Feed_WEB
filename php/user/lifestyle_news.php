...
?>
  ...
  <div class="row g-5">
    <div class="col-md-8">
        <?php    $query1 = mysqli_query($conn, "SELECT COUNT(*) AS num_rows FROM news WHERE category = 'Lifestyle'");
         if ($query) {
      ...
      <h3 class="pb-4 mb-4 fst-italic border-bottom">
       ...
       include('../../db/connection.php');
        //  $query = mysqli_query($conn, "SELECT * FROM news WHERE DATE(date) = CURDATE() OR DATE(date) = DATE_SUB(CURDATE(), INTERVAL 2 DAY);");
         $query = mysqli_query($conn, "select * from news WHERE category = 'Lifestyle' ");
         while($row= mysqli_fetch_array($query))
         {
