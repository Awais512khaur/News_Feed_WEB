...
<a class="nav-item nav-link link-body-emphasis" href="././user/fashion_news.php">Education</a>
...
<button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next" style="margin-top:29rem;"  >
...
<button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev" style="margin-top:29rem;" >
<span class="carousel-control-prev-icon" aria-hidden="true"></span>
<span class="visually-hidden">Previous</span>
</button>
<button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next" style="margin-top:29rem;" >
<span class="carousel-control-next-icon" aria-hidden="true"></span>
<span class="visually-hidden">Next</span>
</button>
</div>
...
<li>Leaking someone's personal information is morally and legally a crime</li>
<li>Using foul language and immoral language iis very despicable act</li>
</ul>
<ul>
<li>جھوٹی خبریں پھیلانا قانون کے تحت جرم ہے۔</li>
<li>کسی کی ذاتی معلومات کو لیک کرنا اخلاقی اور قانونی طور پر ایک جرم ہے۔</li>
<li>غیر اخلاقی زبان استعمال کرنا انتہائی قابل نفرت فعل ہے۔</li>
</ul>
<p>In case of any query contact admin:</p>
<ol>
<li>Phone: +923312099410</li>
<li>Email: muhammadawais03484951435@gmail.com</li>
